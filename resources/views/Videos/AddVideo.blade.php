        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="myForm" action="{{route('upload-video')}}" method="POST" enctype="multipart/form-data" onsubmit="disableButton()">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="Catagory" value="{{old('Catagory')}}" required>
