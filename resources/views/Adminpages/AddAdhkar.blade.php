        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="myForm" action="{{route('add-post')}}" method="POST" enctype="multipart/form-data" onsubmit="disableButton()">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Dua Name</label>
                                        <input type="text" name="dua_name" class="form-control" value="{{old('dua_name')}}" required>
				                ...
				                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group fallback w-100">
                                     <strong>Upload Adhkar Image :</strong>  <input type="file" name="Adhkar_image" class="dropify" data-default-file="" value="{{old('Adhkar_image')}}" required>
